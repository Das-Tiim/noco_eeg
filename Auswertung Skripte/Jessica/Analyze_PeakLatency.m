...
% - pp = start + end index of peak interval
% - EEG_data
...
for sb = 1:Nsub
    ...
    elseif crit == 2
        [Int.S5.local.value(sb), Int.S5.local.index(sb)] = max(Int.S5.interval(sb,:));
    end
    ...
    elseif crit == 2
        [Int.S2.local.value(sb), Int.S2.local.index(sb)] = max(Int.S2.interval(sb,:));
    end
    ...
    elseif crit == 2
        [Int.S6.local.value(sb), Int.S6.local.index(sb)] = max(Int.S6.interval(sb,:));
    end
