...
try
  ...
  %  meanRTs = [tempo.go];
    ...
    pnum=[mainvar.sNum 'RT' '.mat'];
    pathname=fileparts('/home/ngaekp/Schreibtisch/Experimente/Agency/EL2ndproject_tu_nogradual_final/EL2ndproject_tu_nogradual_final/RT/')
matfile=fullfile(pathname,pnum);
%     tt = 1;
    %     nCorrectTrial = 0;
